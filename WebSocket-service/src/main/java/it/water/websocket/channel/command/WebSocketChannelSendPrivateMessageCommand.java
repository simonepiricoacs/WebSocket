...
@FrameworkComponent(services = WebSocketChannelCommand.class, properties = {
        WebSocketChannelConstants.COMMAND_FILTER + "=" + WebSocketChannelCommandType.SEND_PRIVATE_MESSAGE_COMMAND
})
public class WebSocketChannelSendPrivateMessageCommand extends WebSocketChannelAbstractCommand implements WebSocketChannelCommand {

    @Override
    public void execute(WebSocketChannelSession session, WebSocketMessage message, String channelId, WebSocketChannelManager channelManager) {
        checkRequiredParameters(message, WebSocketChannelConstants.CHANNEL_MESSAGE_PARAM_PVT_MESSAGE_RECIPIENT);
