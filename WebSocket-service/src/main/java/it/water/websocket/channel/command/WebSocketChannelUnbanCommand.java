...
@FrameworkComponent(services = {WebSocketChannelCommand.class, WebSocketChannelRemoteCommand.class}, properties = {
        WebSocketChannelConstants.COMMAND_FILTER + "=" + WebSocketChannelCommandType.UNBAN_USER_COMMAND
})
public class WebSocketChannelUnbanCommand extends WebSocketChannelAbstractCommand implements WebSocketChannelRemoteCommand {

    @Override
    public void execute(WebSocketMessage message, String channelId, WebSocketChannelManager channelManager) {
        checkRequiredParameters(message, WebSocketChannelConstants.CHANNEL_MESSAGE_PARAM_BANNED_IP, WebSocketChannelConstants.CHANNEL_MESSAGE_PARAM_BANNED_USERNAME);
