...
public class WebSocketMessageBroker {
    ...
    public WebSocketMessageBroker(Session session) {
     ...
     */
    public void setEncryptionPolicy(WebSocketEncryption encryptionPolicy) {
     ...
     */
    public void setCompressionPolicy(WebSocketCompression compressionPolicy) {
     ...
     */
    public void sendAsync(WebSocketMessage message) {
     ...
     */
    public void sendAsync(WebSocketMessage message, WriteCallback writeCallback) {
     ...
     * @param encodeBase64 if encryption is enabled this boolean forces encoding after encryption.
     *                     If it is not enabled the message is encoded in base64 before sending it through the websocket
    ...
    /**
     * Overridable method for customizing message encryption
     *
     * @param message  message to send
